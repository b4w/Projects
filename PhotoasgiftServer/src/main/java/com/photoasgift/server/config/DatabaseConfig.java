...
@Configuration
@EnableJpaRepositories(value = "com.photoasgift.server.repository")
// говорим, что будем использовать JPA
...
public class DatabaseConfig {
    ...
    /**
     * Получение доступа к property файлам.
     */
    @Resource
    private Environment env;

    /**
     * Позволяет автоматически создавать наши бины и таблицы на основе наших бинов.
     *
     * @return
     */
    @Bean
